...
<body>
    ...
    <script>
        ...
        let mercuryOrbit = new Orbit(200,20).setCentre(solarSystemCentre);
        let mercury = new Planet('#mercury')
            .setOrbit(mercuryOrbit)
            .setDistanceFromSun(100).setSpeed(47.4).setSize(30);

        let venusOrbit = new Orbit(300,30).setCentre(solarSystemCentre);
        let venus = new Planet('#venus')
            .setOrbit(venusOrbit)
            .setDistanceFromSun(200).setSpeed(35).setSize(50);

        let earthOrbit = new Orbit(400,40).setCentre(solarSystemCentre);
